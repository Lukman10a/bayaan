               ...
               <div className="lg:col-span-1 space-y-6">
                  <Card className="bg-brand-section border-brand-border text-center">
                     <CardContent className="p-8">
                        ...
                        <h4 className="text-lg font-bold text-brand-text mb-2">{t('whatsapp')}</h4>
                  ...
                  <Card className="bg-brand-section border-brand-border text-center">
                     <CardContent className="p-8">
                        ...
                        <h4 className="text-lg font-bold text-brand-text mb-2">{t('email')}</h4>
               ...
               <div className="lg:col-span-2">
                  <Card className="bg-brand-section border-brand-border">
                     <CardContent className="p-8 md:p-12">
                        <h2 className="text-2xl font-bold text-brand-text mb-8">{t('sendMsg')}</h2>
                        <form className="space-y-6">
                           <div className="grid md:grid-cols-2 gap-6">
                              <div className="space-y-2">
                                 <label className="text-sm font-bold text-brand-text-secondary">{t('name')}</label>
                                 <input type="text" className="w-full bg-brand-primary border border-brand-border rounded-lg px-4 py-3 text-brand-text focus:outline-none focus:border-brand-accent transition-colors" />
                              </div>
                              <div className="space-y-2">
                                 <label className="text-sm font-bold text-brand-text-secondary">{t('email')}</label>
                                 <input type="email" className="w-full bg-brand-primary border border-brand-border rounded-lg px-4 py-3 text-brand-text focus:outline-none focus:border-brand-accent transition-colors" />
                              </div>
                           </div>
                           <div className="space-y-2">
                           ...
                           <div className="space-y-2">
                              ...
                              <textarea className="w-full bg-brand-primary border border-brand-border rounded-lg px-4 py-3 text-brand-text h-32 resize-none focus:outline-none focus:border-brand-accent transition-colors"></textarea>
                           </div>
