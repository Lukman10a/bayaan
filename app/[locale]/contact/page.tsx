    ...
    <main className="flex-1 pt-20 bg-brand-primary min-h-screen">
      <section className="py-24 relative overflow-hidden bg-brand-section border-b border-brand-border">
         <div className="container mx-auto px-4 text-center relative z-10">
            <h1 className="text-5xl font-heading font-bold text-white mb-6">We Would Love to Hear From You.</h1>
            <p className="text-xl text-brand-text-secondary max-w-2xl mx-auto">Get in touch with our support team for any inquiries.</p>
         </div>
      </section>
               ...
               <div className="lg:col-span-1 space-y-6">
                  <Card className="bg-brand-section border-brand-border text-center">
                     <CardContent className="p-8">
                        ...
                        <Button variant="ghost" size="sm" className="w-full">Message Us</Button>
                     </CardContent>
                  </Card>
                  <Card className="bg-brand-section border-brand-border text-center">
                     <CardContent className="p-8">
                        ...
                        <Button variant="ghost" size="sm" className="w-full">Send Email</Button>
                     </CardContent>
                  </Card>
               </div>
                        ...
                        <form className="space-y-6">
                           <div className="grid md:grid-cols-2 gap-6">
                              <div className="space-y-2">
                                 <label className="text-sm font-bold text-brand-text-secondary">Name</label>
                              ...
                              <div className="space-y-2">
                                 <label className="text-sm font-bold text-brand-text-secondary">Email</label>
                           ...
                           <div className="space-y-2">
                              <label className="text-sm font-bold text-brand-text-secondary">Subject</label>
                              <input type="text" className="w-full bg-brand-primary border border-brand-border rounded-lg px-4 py-3 text-white focus:outline-none focus:border-brand-accent transition-colors" />
                           </div>
                           <div className="space-y-2">
                              <label className="text-sm font-bold text-brand-text-secondary">Message</label>
                           ...
                           <p className="text-xs text-brand-text-muted mt-4">We respond within 24 hours, in shaa Allah.</p>
                        </form>
                     </CardContent>
                  </Card>
               </div>
