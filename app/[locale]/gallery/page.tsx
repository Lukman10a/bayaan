    ...
    <main className="flex-1 pt-20 bg-brand-primary min-h-screen">
      <section className="py-24 relative overflow-hidden bg-brand-section border-b border-brand-border">
         <div className="container mx-auto px-4 text-center relative z-10">
            <h1 className="text-5xl font-heading font-bold text-white mb-6">A Glimpse Into Our Community.</h1>
            <p className="text-xl text-brand-text-secondary max-w-2xl mx-auto">Student achievements, class highlights, and events.</p>
         </div>
      </section>

      <section className="py-24">
         <div className="container mx-auto px-4 text-center">
            <p className="text-brand-text-muted mb-8">Gallery masonry grid will be displayed here.</p>
